export function Footer() {
  ...
  return (
    <footer className="bg-brand-dark border-t border-white/10">
      {/* Top banner CTA */}
      <div
        className="border-b px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4 max-w-7xl mx-auto"
      ...
      >
        ...
        <div className="flex gap-3 shrink-0">
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 text-xs font-semibold tracking-widest uppercase text-white transition-colors"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            <div className="flex flex-col mb-4">
              <span className="text-2xl font-bold tracking-widest uppercase" style={{ fontFamily: "Georgia, serif", color: "#C9A96E" }}>
                Romano
              </span>
              <span className="text-base tracking-[0.4em] uppercase text-white/70" style={{ fontFamily: "Georgia, serif" }}>
                Botta
              </span>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 inline-block text-xs tracking-widest uppercase underline underline-offset-4"
              style={{ color: "#C9A96E" }}
            >
              romanobotta.com
            </a>
          ...
          {/* Links */}
          <div>
            <h4 className="text-xs tracking-widest uppercase mb-4 font-semibold" style={{ color: "#C9A96E" }}>
              Навигация
            </h4>
