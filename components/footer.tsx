...
export function Footer() {
  ...
  return (
    <footer className="bg-[#1a1a1a] border-t border-white/10">
      {/* Top banner CTA */}
      <div className="border-b px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4 max-w-7xl mx-auto" style={{ borderColor: "rgba(201,169,110,0.2)" }}>
        ...
        <div className="flex gap-3 shrink-0">
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 text-xs font-semibold tracking-widest uppercase text-white bg-[#25D366] hover:bg-[#1ebe5d] transition-colors"
          >
